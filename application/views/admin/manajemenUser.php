                    ...
                    <div class="box box-primary">
                        <div class="box-body box-profile">
                            ...
                            <div class="pull-right">
                                ...
                                <?php } else { ?>
                                  <a href="<?php echo base_url('index.php/admin/manajemen_user/delete/').$usr->id ?>" class="btn btn-danger btn-sm tombol-yakin" data-isiData="Ingin menghapus user ini!">
  ...
  <div class="modal fade" id="tambahData" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form action="<?php echo base_url('index.php/admin/manajemen_user/insert') ?>" method="POST">
