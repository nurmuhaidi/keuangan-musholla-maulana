...
<body class="hold-transition">
    <div class="container">
        ...
        <table width="100%" style="margin-top: 15px;">
            <tr>
              <td width="120px">Jumlah Data</td>
              <td width="15px">:</td>
              <td> <?php echo $jumlah_pengeluaran_barang ?> Data</td>
              <td width="20%"> </td>
        ...
        <table class="table table-bordered" style="margin-top: 15px">
            ...
            <tbody>
                <?php  
                  $no = 1;
                  foreach ($pengeluaran_barang as $pBrg) {
                ?>
                  <tr>
                    <td><?= $no++; ?>.</td>
                    <td><?= date('d-M-Y', strtotime($pBrg->tanggal)) ?></td>
                    <td><?= $pBrg->namaBarang ?></td>
                    <td><?= $pBrg->keterangan ?></td>
                  </tr>
                <?php } ?>
            </tbody>
        </table>
