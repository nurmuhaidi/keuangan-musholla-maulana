              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <!-- Tombol Delete -->
                    <a href="<?php echo base_url('index.php/admin/pemasukan_uang/delete/'.$puang->id ) ?>" class="btn btn-danger btn-sm tombol-yakin" data-isiData="Ingin menghapus data pemasukan uang ini?">
